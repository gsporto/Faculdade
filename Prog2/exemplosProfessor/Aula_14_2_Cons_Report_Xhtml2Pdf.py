...
Str=read_html("./Html_Report/Nota_Fiscal.html")
print("Reading: './Html_Report/Nota_Fiscal.html'")
## print(Str)
convert_html_to_pdf(Str, './Html_Report/Report_02.pdf')
print("Creating: './Html_Report/Report_02.pdf'")